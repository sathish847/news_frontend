...
export async function generateStaticParams() {
   ...
   const apiEndpoints = [
      'https://news-backend-emfx.onrender.com/api/news/public',
      'https://news-backend-emfx.onrender.com/api/subnews/public',
      'https://news-backend-emfx.onrender.com/api/mini_news/public',
      'https://news-backend-emfx.onrender.com/api/trending_news/public',
      'https://news-backend-emfx.onrender.com/api/main_news/public'
   ];
...
export default async function Page({ params }: Props) {
   ...
   if (!single_blog) {
      try {
         const response = await fetch('https://news-backend-emfx.onrender.com/api/news/public');
   ...
   if (!single_blog) {
      try {
         const response = await fetch('https://news-backend-emfx.onrender.com/api/mini_news/public');
         if (response.ok) {
            const data = await response.json();
            const apiBlog = data.data.find((item: any) => item.slug === blogId);
            if (apiBlog) {
   ...
   if (!single_blog) {
      try {
         const response = await fetch('https://news-backend-emfx.onrender.com/api/trending_news/public');
         if (response.ok) {
            const data = await response.json();
            const apiBlog = data.data.find((item: any) => item.slug === blogId);
            if (apiBlog) {
   ...
   if (!single_blog) {
      try {
         const response = await fetch('https://news-backend-emfx.onrender.com/api/main_news/public');
         if (response.ok) {
            const data = await response.json();
            const apiBlog = data.data.find((item: any) => item.slug === blogId);
            if (apiBlog) {
